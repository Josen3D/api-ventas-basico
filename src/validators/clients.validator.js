...
import { validateResults } from "../utils/validarot.handler.js";
...
export const validatorCreateClient = [
  ...
  check("fathers_lastname").exists().notEmpty().isLength({ min: 5, max: 20 }),
  check("mothers_lastname").exists().notEmpty().isLength({ min: 5, max: 20 }),
